function TRANSFERTrainSystem(net)
...
while (1)
    ...
    [~, res, ~] = TRANSFEREvaluateSystem(net, inputs, reference, true);
    
    net = TRANSFERUpdateNet(net, res, it);
    ...
    if (mod(it, param.testNetIter) == 0)
        ...
        curError = TRANSFERTestDuringTraining(net);
